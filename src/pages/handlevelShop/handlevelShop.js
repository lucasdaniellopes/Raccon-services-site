    ...
    function addChampionSkin(champ){
      ...
      const skinHtml2 = `<li class="content-collection__results-champs__champ relative max-w-[200px] w-[31%] sm:w-[25%] flex justify-center hover:scale-105 duration-300">
                  <a href="javascript:void(0)" data-slug="jhin-project2" name="jhin-project2">
                    ...
                    <div class="absolute top-2 font-normal text-[8px] md:text-sm bg-black/50 sm:w-[88%] w-[81%] ml-2">
                      <span class="text-wrap text-center block w-full">jhin-project</span>
                    </div>
                    <div class="absolute bottom-2 font-normal text-[8px] md:text-sm bg-black/50 sm:w-[88%] w-[81%] ml-2">
                      <span class="text-wrap text-center block w-full">R$36.00</span>
                    </div>
                  </a>
                </li>`
        document.getElementById('champions-options').insertAdjacentHTML('beforeend',skinHtml);
        document.getElementById('champions-options').insertAdjacentHTML('beforeend',skinHtml2);
    }
